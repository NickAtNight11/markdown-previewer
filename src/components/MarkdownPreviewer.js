...
function MarkdownPreviewer() {
  ...
  const inittext = "Welcome to the GitHub Markdown Previewer!\rThe following are basic functions of the Markdown Language: \r\r<!-- This is a Markdown comment -->\r\r# This is a Header.\r## This is a Subheader.\r\r### This is a Sub-subheader.\r\r[This is a link](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax)\r\rText can become **bolded**, *italicized*, or ***both***. You can also ~strike through it.~\r\r> This text is a quote.\r\rYou can also make\r\r1. Numbered\r2. Lists\r\ror\r\r- Bulleted\r- Lists\r\r- [x] This is a checked task.\r- [ ] This is an unchecked task.\r\rYou can `quote code` as well.\r\r```\rfunction getCode() {\r print(\"This is a code block\");\r}\r```\r\r![You can also import an image.](https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png)";
